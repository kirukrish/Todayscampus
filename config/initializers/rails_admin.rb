# RailsAdmin config file. Generated on March 14, 2013 12:32
...
RailsAdmin.config do |config|
  ...
  # config.excluded_models = ['Role', 'Topic', 'User']

  ################  Global configuration  ################

  # Set the admin name here (optional second array element will appear in red). For example:
  config.main_app_name = ['Todays Campus', 'Admin']
  ...
  config.excluded_models = ['Attachment', 'Role']

  # Include specific models (exclude the others):
  # config.included_models = ['Role', 'Topic', 'User']
